...
K.options = {
	...
	pluginsPath : K.basePath + '../editor/plugins/',
	themeType : 'default',
	langType : 'ru_Ru',
	urlType : '',
	newlineTag : 'p',
...
_extend(KUploadButton, {
	init : function(options) {
		...
		var html = [
			...
			hiddenElements.join(''),
			'<input type="button" class="ke-button-common ke-button btn btncolor" value="' + title + '" />',
			'</span>',
...
function _createButton(arg) {
	...
	var name = arg.name || '',
		...
		btn = K('<input class="ke-button-common ke-button btn btncolor" type="button" value="' + name + '" />');
	if (arg.click) {
		btn.click(arg.click);
	}
	span.append(btn);
...
function _create(expr, options) {
	...
	options.pluginsPath = _undef(options.pluginsPath, options.basePath + '../editor/plugins/');
